// v3.2 A–O: production and tester use the same runtime and canonical knowledge.
...
try {
  ...
  const canonical = read("knowledge/inobr/artem_unified_knowledge_base_v3_2.md");
  ...
  assert.match(canonical, /Версия 3\.2/);
  ...
  assert.match(EVALUATOR_PROMPT, /KB v3\.2/);
  ...
  console.log("PASS: v3.2 A–O, canonical source, prod/tester runtime parity, education guards, acceptance choice, refusal and evaluator contract.");
} finally {
  hooks.deregister();
}
