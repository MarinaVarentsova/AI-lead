...
const config = read("deploy/coolify/frontend-spa-locations.conf");
...
} else console.log("PASS: static nginx snippet and unchanged React routes. Live nginx/deployment not tested.");
