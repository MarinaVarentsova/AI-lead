...
Source: knowledge/inobr/artem_unified_knowledge_base_v3_2.md, copied unchanged from the
user's final instruction. Consultant retrieval no longer reads the legacy KB.
Selected knowledge sections are indexed for retrieval; the complete canonical v3.2
