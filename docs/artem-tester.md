...
executive summary, четыре итоговых балла, системные проблемы со ссылками на номера
сценариев, сильные стороны, изменения и границы изменений. Codex task строится
backend из проверенного заключения; неподтверждённые бизнес-факты помечаются как
требующие решения владельца и не превращаются в готовое правило.
