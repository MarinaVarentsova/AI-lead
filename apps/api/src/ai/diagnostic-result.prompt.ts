...
Поле recommendation — готовый пользовательский текст из 2–4 коротких предложений.
Обращайся прямо к человеку: «У вас...», «С вашим опытом...», «В вашем случае...». Сначала
назови релевантную базу пользователя, затем конкретное направление и коротко объясни пользу.
Не используй технические формулировки «Пользователь имеет», «Рекомендация должна учитывать»
и не повторяй названия JSON-полей.
