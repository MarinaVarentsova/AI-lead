...
Применяй общую инструкцию v3.7. Сначала извлеки содержательный intent, даже если вопрос грубый или саркастический, и ответь на последний вопрос, обычно 2–5 предложений.
