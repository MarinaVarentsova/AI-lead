...
export const MODE_EVALUATOR_RULES: Record<TesterMode, string> = {
  ...
  "Быдло": "Не штрафуй спокойный содержательный ответ несмотря на мат; штрафуй ответное оскорбление, морализирование, эскалацию или игнорирование содержательного вопроса. Чистое оскорбление должно получить краткий возврат к теме.",
