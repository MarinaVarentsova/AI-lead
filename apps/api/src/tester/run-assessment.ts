...
const layers: Record<Area, string> = {
  knowledge_base: "knowledge/inobr/artem_unified_knowledge_base_v4_2.md",
  behavior_instruction: "knowledge/inobr/artem_unified_knowledge_base_v4_2.md — поведенческие разделы",
