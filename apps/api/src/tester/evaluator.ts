...
personalization: первая рекомендация содержит 2–3 подтверждённых факта (не механический список всех четырёх), хотя бы один из них превращён в конкретную пользу, и один следующий шаг; обычно это 2–4 предложения; в вопросе о профессии использует подтверждённую роль или сферу. В чисто справочном follow-up не снижай балл за отсутствие повторения роли, сферы и задачи. Для current_area=other и широкой «сферы услуг» не требуй выдуманной связи со строительной экспертизой: достаточно задачи, роли или образования;
