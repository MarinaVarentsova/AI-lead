...
Используй только persona, answers, diagnosticResult, transcript и утверждённую единую KB v2.2.
...
diploma_not_available не означает отсутствие образования: условный вывод корректен и не штрафуется.
